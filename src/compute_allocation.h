...
private:
    ...
    void geomWithin(QSet<Geometry*>* cellsWithin, const QSet<Geometry*>& cells, Geometry* cell, double distance = -1.0, double travelTime = -1.0, DistanceStat ds = AutoDStat, TravelTimeStat ts = MedTTStat);
